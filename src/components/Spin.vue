...
const spin = () => {
    ...
    deg.value = Math.floor(Math.random() * (min - max)) + max

    const divider = 360 / wheelValues.length
    const offset = divider / 2
    wheelValue.value = wheelValues[
    ...
    setTimeout(()=>{
        emit('volumeChange', wheelValue.value / 100)
    }, 1000)
}
</script>
...
<template>
    <div class="flex flex-col justify-center items-center">
        <div class="text-4xl mb-10">Gire a roleta para escolher o volume:</div>
        <div class="relative w-[500px] h-[500px]">
            <div ref="wheel"
                ...
                <div>
                    <span class="w-6/12 inline-block absolute h-1/2 bg-red-600 left-0 top-[120px] clip-path-span1">
                        <p
                            class="w-16 h-16 text-4xl text-center absolute top-[60%] left-[30%] transform -translate-x-[50px] -translate-y-[50px]">
                            5
                        </p>
                    </span>
                    <span class="w-6/12 inline-block absolute h-1/2 bg-teal-400 -right-0 top-[120px] clip-path-span2">
                        <p
                            class="w-16 h-16 text-4xl text-center absolute top-[60%] left-[80%] transform -translate-x-[50px] -translate-y-[50px]">
                            75
                        </p>
                    </span>
                    <span class="w-6/12 inline-block absolute h-1/2 bg-purple-600 bottom-0 left-[120px] clip-path-span3">
                        <p
                            class="w-16 h-16 text-4xl text-center absolute top-[80%] left-[55%] transform -translate-x-[50px] -translate-y-[50px]">
                            25
                        </p>
                    </span>
                    <span class="w-6/12 inline-block absolute h-1/2 bg-green-700 top-0 left-[120px] clip-path-span4">
                        <p
                    ...
                    <span class="w-6/12 inline-block absolute h-1/2 bg-red-500 left-[242px] -bottom-0.5 clip-path-span6">
                        <p
                            class="w-16 h-16 text-4xl text-center absolute top-[60%] left-[60%] transform -translate-x-[50px] -translate-y-[50px]">
                            50
                        </p>
                    </span>
                    <span class="w-6/12 inline-block absolute h-1/2 bg-yellow-500 right-[242px] -top-0.5 clip-path-span7">
                        <p
                            class="w-16 h-16 text-4xl text-center absolute top-[60%] left-1/2 transform -translate-x-[50px] -translate-y-[50px]">
                            35
                        </p>
                    </span>
                    <span class="w-6/12 inline-block absolute h-1/2 bg-orange-500 left-[242px] -top-0.5 clip-path-span8">
                        <p
                            class="w-16 h-16 text-4xl text-center absolute top-[60%] left-[60%] transform -translate-x-[50px] -translate-y-[50px]">
                            69
                        </p>
